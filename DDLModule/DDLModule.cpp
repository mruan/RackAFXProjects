...
void CDDLModule::cookVariables()
{
	...
	m_fFeedback = m_fFb_pct / 100.0;
	m_fWetLevel = m_fWetLv_pct / 100.0;

	// calculate read/write index
...
{
	// Add your code here:
	m_nBufferSize = 2 * m_nSampleRate; // 2 sec of delay @ fs
...
// **--0xDEA7--**
	...
	ui1->m_pUserCookedFloatData = &m_fFb_pct;
	ui1->m_pUserCookedDoubleData = NULL;
	ui1->m_pUserCookedUINTData = NULL;
	ui1->cControlUnits = "%                                                               ";
	ui1->cVariableName = "m_fFb_pct";
	...
	ui2->m_pUserCookedFloatData = &m_fWetLv_pct;
	ui2->m_pUserCookedDoubleData = NULL;
	ui2->m_pUserCookedUINTData = NULL;
	ui2->cControlUnits = "%                                                               ";
	ui2->cVariableName = "m_fWetLv_pct";
